...
namespace ApplicationToActivityMapper
{
    ...
    public class ActivityMapper : IActivityMapper
    {
        ...
        private static readonly List<string> BrowserApps = new List<string> { "iexplore", "chrome", "firefox", "opera", "safari", "applicationframehost", "edge", "news", "twitchui" }; // ApplicationFrameHost stands for Edge
